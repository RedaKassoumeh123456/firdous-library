        ...
        <section className="p-6 md:p-10">
            <div className="bg-gray-200 p-5 mx-auto w-full max-w-[800px]">
                ...
                <div className="mt-1 flex gap-1">
                    <button className="py-2 px-3 w-full text-center bg-primary text-gray-200 rounded-md hover:bg-opacity-85 transition">حذف</button>
                    <button className="py-2 px-3 w-full text-center bg-secondary text-gray-200 rounded-md hover:bg-opacity-85 transition">تعديل</button>
                </div>
