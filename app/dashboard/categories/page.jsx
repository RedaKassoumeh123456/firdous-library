        ...
        <section className="p-6 md:p-10 h-[67.5vh]">
            <div className="bg-gray-200 p-5 mx-auto w-full max-w-[800px]">
                ...
                <div className="">
                    ...
                    <div className="flex justify-between items-center p-2 border-b border-gray-400 hover:bg-gray-300">
                        <h1 className="text-secondary text-xl">غير مصنف</h1>
                        <div className="flex">
                            <button type='button' className="block py-2 px-4 bg-secondary bg-opacity-50 rounded-md ml-3 text-gray-200 "> تعديل</button>
                            {/* {const categoryId = cat._id.toString()} */}
                            <button type="button" className="block py-2 px-4 bg-primary bg-opacity-50 rounded-md ml-3 text-gray-200 ">حذف </button>
